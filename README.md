# PropTrack v2.0 - Modular Architecture
...
```
proptrack/
├── index.html              # Minimal HTML shell (4.5KB)
├── favicon.png
├── styles/
│   └── main.css            # All styles extracted (15KB)
├── js/
│   ├── config.js           # Configuration
│   ├── api-client.js       # Backend API client
│   ├── state.js            # Global state management
│   ├── utils.js            # Utility functions
│   ├── constants.js        # Team mappings & constants
│   ├── main.js             # Entry point & initialization
│   └── components/
│       ├── player-card.js  # Player/goalie card rendering
│       ├── display.js      # Grid display logic
│       ├── watchlist.js    # Watchlist UI
│       ├── parlay.js       # Parlay calculator
│       ├── modal.js        # Game log modals
│       ├── filters.js      # Search & filter logic
│       └── theme.js        # Dark mode toggle
├── api/                    # Backend (Vercel Serverless)
│   ├── calculate-rankings.js      # 🔒 Proprietary player rankings
│   ├── calculate-goalie-rankings.js # 🔒 Proprietary goalie rankings
│   ├── calculate-hit-rates.js     # 🔒 Hit rate algorithms
│   ├── get-data.js                # Serve cached data
│   ├── nhl.js                     # NHL API proxy
│   └── update-data.js             # Cron job for data refresh
├── package.json
└── vercel.json
```
